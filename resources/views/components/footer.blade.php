    ...
    <div class="a">
        <div class="mb hd ga">
            <div class="bc ek/2 kl/12 df">
                <div class="la">
                    ...
                    <p class="eh ug lh qa">
                        <a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="7d1e11120e180f0d1c1a183d18101c1411531e1210">{{ $contactData->email }}</a>
                    </p>
                    <p class="eh ug lh qa">{{ $contactData->address }}</p>
                    <p class="eh ug lh qa">{{ $contactData->phone }}</p>
                </div>
            </div>
            <div class="bc ek/2 ll/12 df">
                <div class="la">
                    ...
                    <ul>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> The Studio </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Sponsoring </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Newsletter </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Contact Us </a> </li>
                    </ul>
                </div>
            </div>
            <div class="bc ek/2 ml/12 df">
                <div class="la">
                    ...
                    <ul>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Hot Stuff </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Perfect Place </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Vintage </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Products </a> </li>
                    </ul>
                </div>
            </div>
            <div class="bc ek/2 ll/12 df">
                <div class="la">
                    ...
                    <ul>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Style </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Health </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Relationship </a> </li>
                        <li> <a href="javascript:void(0)" class="lb ug lh ua ui"> Legal & Privacy </a> </li>
                    </ul>
                </div>
            </div>
        </div>
        <div class="xa cg _d ee ke">
            <div class="mb id kd oa">
                <a href="{{ $socialData->facebook }}" class="mb id kd gc tb on ha lh ui" aria-label="social-link" name="social-link">
                ...
                <a href="{{ $socialData->twitter }}" class="mb id kd gc tb on ha lh ui" aria-label="social-link" name="social-link">
                    <svg width="32" height="32" viewBox="0 0 32 32" class="ye">
                    ...
                    <a href="{{ $socialData->linkedin }}" class="mb id kd gc tb on ha lh ui" aria-label="social-link" name="social-link">
                        <svg width="32" height="32" viewBox="0 0 32 32" class="ye">
